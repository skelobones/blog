---
title: Cable-Stayed 3d printer (Build)
tags:
  - Article
publish: true
...
aliases:
  - printer frame
enableToc: true
next: Cable-Stayed 3d printer (Installation)
---
...
>[!example]
>SVG doodle *very* roughly explaining what my deisgn is.
...
The final step was to hacksaw in a flat head profile. I found that center-punching both the absolute centre and direction I wished to cut (see below) made it easier to begin a cut. I held the hacksaw by its main handle and by pinching the safe side of the blade when doing this. Looking back, I could've just tightened the blade to make it rigid. *Did you know they could be tightened? What mundane knowledge heh.*

![[image.psd(22).png|300]]
...
>[!info] Images
>![[image.psd(23).png|300|]]
>![[image.psd(24).png]]

>[!info] Handtools Used
>![[image.psd(21).png|300]]
...
I had to clean up the inside afterwards, which I spent too long trying to do with a file only to realise "Wait, I have chiselling good ~~looks~~ cold chisels"
...
I'll write a separate blog post for the installation. Thankyou for reading through this verbose mess.
